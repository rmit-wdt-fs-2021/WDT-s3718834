...
<h3>MVC</h3>
MVC dictates the overal structure of my code, it is why my view, controller and model are seperated.
...
I can change my code that interacts with it without editting the engine directly. Once again this 
...
the same data type which makes passing data signifcantly easier and performant. It also allows me to
...
the entire project further indorses this choice.

<h2> Async Use </h2>
My use of asynchronous functionality is centred around the engine where the most amount of computation
...
<br><br> You can find async in all engine classes and it ends in the controller classes.
